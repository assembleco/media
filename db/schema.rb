...
ActiveRecord::Schema.define(version: 2021_05_23_174549) do
  ...
  create_table "occupations", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["person_id"], name: "index_occupations_on_person_id"
    t.index ["role_id"], name: "index_occupations_on_role_id"
  end
  ...
  add_foreign_key "occupations", "people"
  add_foreign_key "occupations", "roles"
